...
def input_args():
    ...
    parser.add_argument("--pre_model", type=str, default='F:\Face Forgery Detection\checkpoints\FF++/checkpoint_3.tar',
...
if __name__ == '__main__':
    ...
    for batch_idx, (val_input, val_label, img_lap, encoder_save_path) in enumerate(val_bar):
        ...
        with torch.no_grad():
            test_output = model(val_input, img_lap, encoder_save_path)
            _, val_predict = torch.max(test_output.data, 1)
